...
// 채팅방 메시지 조회 (GET)
Arouter.get("/HospitalA/:my_id/reserver/:doctor_id/hoschat", (req, res) => {
...
Brouter.get("/HospitalB/:my_id/reserver/:doctor_id/hoschat", (req, res) => {
  const { my_id, doctor_id } = req.params;
  const currentUserID = req.session.user.id;
...
Crouter.get("/HospitalC/:my_id/reserver/:doctor_id/hoschat", (req, res) => {
  const { my_id, doctor_id } = req.params;
  const currentUserID = req.session.user.id;
...
// 새로운 메시지 전송 (POST)
Arouter.post("/:my_id/reserver/:doctor_id/hoschat", (req, res) => {
  const { my_id, doctor_id } = req.params;
...
Brouter.post("/:my_id/reserver/:doctor_id/hoschat", (req, res) => {
  const { my_id, doctor_id } = req.params;
  const { receiver_id, content } = req.body;
  const session_id = req.session.user.id;
...
Crouter.post("/:my_id/reserver/:doctor_id/hoschat", (req, res) => {
  const { my_id, doctor_id } = req.params;
  const { receiver_id, content } = req.body;
  const session_id = req.session.user.id;
